...
with tab2:
    ...
    if len(df_all) < k:
        ...
        st.caption(
            ...
            "Berguna untuk melihat rentang, median, dan potensi outlier pada tiap kategori."
        )
        ...
        # urutan tampilan: asnaf sesuai FEATURES, kategori sesuai label klaster (Rendah -> Tinggi)
        ...
        ax_box.legend(title="Kategori", loc="upper right", fontsize=8)
